        ...
        connect:function(){
            ...
            this.stompClient.connect({}, function(frame) {
                ...
                this.subscribe('/sendadm', function(msg) {
                    ...
                    $('#progress1').css('width',JSON.parse(msg.body).content1/500*100+'%');
                    $('#progress1').attr('aria-valuenow',JSON.parse(msg.body).content1/500*100);

                    $('#progress2').css('width',JSON.parse(msg.body).content2/500*100+'%');
                    $('#progress2').attr('aria-valuenow',JSON.parse(msg.body).content2/500*100);

                    $('#progress4').css('width',JSON.parse(msg.body).content4/500*100+'%');
                    $('#progress4').attr('aria-valuenow',JSON.parse(msg.body).content4/500*100);
                });
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div id="content1_msg" class="h5 mb-0 mr-3 font-weight-bold text-gray-800">여기봐라</div>
                                </div>
                                <div class="col">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div id="content2_msg" class="h5 mb-0 mr-3 font-weight-bold text-gray-800">15초에</div>
                                </div>
                                <div class="col">
                                    <div class="progress progress-sm mr-2">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div id="content3_msg" class="h5 mb-0 mr-3 font-weight-bold text-gray-800">한번씩</div>
                                </div>
                                <div class="col">
                                    <div class="progress progress-sm mr-2">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div id="content4_msg" class="h5 mb-0 mr-3 font-weight-bold text-gray-800">여기봐라</div>
                                </div>
                                <div class="col">
                                    <div class="progress progress-sm mr-2">
